...
export type CreateProductReviewMutation = { __typename?: 'Mutation', review?: { __typename?: 'Review', content: string, headline: string, id: string, name: string, rating?: number | null, product?: { __typename?: 'Product', name: string } | null } | null };
...
export type GetProductsListTestQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsListTestQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, price: number, name: string, slug: string }> };

export type GetProductsListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsListQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', price: number, name: string, slug: string, images: Array<{ __typename?: 'Asset', id: string, url: string, width?: number | null, height?: number | null }>, categories: Array<{ __typename?: 'Category', id: string, name: string }> }> };
...
export type GetProductDetailsBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, slug: string, name: string, description: string, price: number, images: Array<{ __typename?: 'Asset', url: string, width?: number | null, height?: number | null }> } | null };

export type ReviewContentFragment = { __typename?: 'Review', content: string, headline: string, id: string, name: string, rating?: number | null, product?: { __typename?: 'Product', name: string } | null };
...
export type GetReviewsForProductSlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', reviews: Array<{ __typename?: 'Review', content: string, headline: string, id: string, name: string, rating?: number | null, product?: { __typename?: 'Product', name: string } | null }> } | null };
...
export const GetProductsListTestDocument = gql`
...
/**
 * __useGetProductsListTestQuery__
 *
 * To run a query within a React component, call `useGetProductsListTestQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductsListTestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductsListTestQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetProductsListTestQuery(baseOptions?: Apollo.QueryHookOptions<GetProductsListTestQuery, GetProductsListTestQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductsListTestQuery, GetProductsListTestQueryVariables>(GetProductsListTestDocument, options);
      }
export function useGetProductsListTestLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductsListTestQuery, GetProductsListTestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductsListTestQuery, GetProductsListTestQueryVariables>(GetProductsListTestDocument, options);
        }
export type GetProductsListTestQueryHookResult = ReturnType<typeof useGetProductsListTestQuery>;
export type GetProductsListTestLazyQueryHookResult = ReturnType<typeof useGetProductsListTestLazyQuery>;
export type GetProductsListTestQueryResult = Apollo.QueryResult<GetProductsListTestQuery, GetProductsListTestQueryVariables>;
